...
<BasePage>
    <div class="grid grid-cols-1 gap-6 text-center">
        <h1 class="text-turquoise text-4xl">Hey my name is Konrad</h1>
        <p class="text-blue-light text-3xl">
            You found my website where I <span class="text-cream">collect</span>
            and <span class="text-cream">document</span> my work
        </p>
        <p class="text-blue-light text-3xl">
